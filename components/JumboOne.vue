<template>
  ...
  <div class="w-full">
    <img src="https://images.pexels.com/photos/92904/pexels-photo-92904.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="w-full rounded">
  </div>
  <div class="px-2 pb-5">
    ...
    <div class="flex flex-wrap justify-center items-center">
      ...
      <div class="text-sm mt-3 md:mt-0 lg:mt-0">
        ...
        <p class="text-gray-600 mt-3 font-thin">
          <span class="pr-1"><a class="text-underline" href="#">#ReactJS</a></span>
          <span class="pr-1"><a class="text-underline" href="#">#AngularJS</a></span>
          <span class="pr-1"><a class="text-underline" href="#">#VueJS</a></span>
          <span class="pr-1"><a class="text-underline" href="#">#NuxtJS</a></span>         
        </p>
      </div>
    </div>
  </div>
...
<div class=" float-right ">
    <a href="https://betheltech.net/" target="_blank" class=""><img class="w-48 rounded-lg" src="~/assets/images/bethel-tech-logo.jpg" alt=""></a>
